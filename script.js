// Global AOS config — smoother like Tala Prattoy
AOS.init({
  duration: 1200,
  easing: 'ease-in-out',
  once: true,
...
<div class="page-footer">
        © 1999–2026ABC Club. All Rights Reserved. | Designed & Developed by Arpan Garai
      </div>
    `
};
...
// Make sure to call initLightbox after loading the gallery section
function loadSection(section) {
  const mainContent = document.getElementById("main-content");
